    ...
    return (
        <div className={className} {...props} ref={ref}>
            <Card className={styles.product}>
                ...
                <div className={styles.tags}>{product.categories.map(c => <Tag key={c} className={styles.tag} color='ghost'>{c}</Tag>)}</div>
            ...
            <Card color="blue" className={styles.reviews} ref={reviewRef} animate={isReviewOpened ? 'visible' : 'hidden'} variants={variants} initial={'hidden'}>
